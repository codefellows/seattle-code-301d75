...
// "this" refers to the Student object, specifically whichever Student object that is using the prototype function
// 2. What is "this" when joe.scopeArrow() is invoked?
// the keyword "this" is lexically bound in arrow functions.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not bind their own this, instead, they inherit the one from the parent scope, which is called "lexical scoping". non-arrow functions will always bind "this" to the global scope.
